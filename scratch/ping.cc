...
// 4. Create & setup wifi channel
  ...
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
                                         onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.000040)));
  ...
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.050)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (2)));
 // flow 3:  node 3 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.020)));
