...
void experiment (bool enableCtsRts, std::string wifiManager)
{
 ...
 lossModel->SetLoss (nodes.Get (1)->GetObject<MobilityModel> (), nodes.Get (10)->GetObject<MobilityModel> (), 0); // set symmetric loss 5 <-> 1 to 50
lossModel->SetLoss (nodes.Get (1)->GetObject<MobilityModel> (), nodes.Get (11)->GetObject<MobilityModel> (), 0); // set symmetric loss 5 <-> 1 to 50
lossModel->SetLoss (nodes.Get (1)->GetObject<MobilityModel> (), nodes.Get (12)->GetObject<MobilityModel> (), 0); // set symmetric loss 5 <-> 1 to 50
lossModel->SetLoss (nodes.Get (1)->GetObject<MobilityModel> (), nodes.Get (13)->GetObject<MobilityModel> (), 0); // set symmetric loss 5 <-> 1 to 50
lossModel->SetLoss (nodes.Get (1)->GetObject<MobilityModel> (), nodes.Get (14)->GetObject<MobilityModel> (), 0); // set symmetric loss 5 <-> 1 to 50
...
// 4. Create & setup wifi channel
  ...
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.000140)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (0)));

  // flow 2:  node 2 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3001100bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.091)));
 ...
 // flow 5:  node 5 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.250)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (5)));
// flow 6:  node 6 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.273)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (6)));
// flow 7:  node 7 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.091)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (7)));
// flow 8:  node 8 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.273)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (8)));
// flow 9:  node 9 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.273)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (9)));
 // flow 10:  node 10 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.273)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (10)));
// flow 11:  node 11 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.2412)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (11)));
// flow 12:  node 12 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.0602)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (12)));
// flow 13:  node 13 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.1201)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (13)));
// flow 14:  node 14 -> node 1
  onOffHelper.SetAttribute ("DataRate", StringValue ("3000000bps"));
  onOffHelper.SetAttribute ("StartTime", TimeValue (Seconds (1.0900)));
  cbrApps.Add (onOffHelper.Install (nodes.Get (14)));
  ...
  echoClientHelper.SetAttribute ("StartTime", TimeValue (Seconds (0.06)));
  pingApps.Add (echoClientHelper.Install (nodes.Get (10)));
  echoClientHelper.SetAttribute ("StartTime", TimeValue (Seconds (0.005)));
  pingApps.Add (echoClientHelper.Install (nodes.Get (11)));
  echoClientHelper.SetAttribute ("StartTime", TimeValue (Seconds (0.009)));
  pingApps.Add (echoClientHelper.Install (nodes.Get (12)));
  echoClientHelper.SetAttribute ("StartTime", TimeValue (Seconds (0.008)));
  pingApps.Add (echoClientHelper.Install (nodes.Get (13)));
  echoClientHelper.SetAttribute ("StartTime", TimeValue (Seconds (0.008)));
  pingApps.Add (echoClientHelper.Install (nodes.Get (14)));
